import 'package:beauty_user/core/widgets/date_picker.dart';
...
extension NumberToArabic on String {
  ...
  Color? toColor() {
    final hexColor = replaceAll("Color(", "").replaceAll(")", "");
    final value = int.tryParse(hexColor);
    return value != null ? Color(value) : Colors.black;
  }
