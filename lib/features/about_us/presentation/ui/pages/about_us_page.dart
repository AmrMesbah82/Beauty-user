...
part '../widget/about_us_page/b_p.dart';
part '../widget/about_us_page/reveal_coordinator.dart';
part '../widget/about_us_page/reveal_coordinator_widget.dart';
part '../widget/about_us_page/reveal.dart';
part '../widget/about_us_page/svg_pulse_loader.dart';
part '../widget/about_us_page/about_page_view.dart';
part '../widget/about_us_page/headings_svg_desktop.dart';
part '../widget/about_us_page/headings_svg_mobile.dart';
part '../widget/about_us_page/about_header_desktop.dart';
part '../widget/about_us_page/about_header_mobile.dart';
part '../widget/about_us_page/about_body_desktop.dart';
part '../widget/about_us_page/desktop_top_tab_item.dart';
part '../widget/about_us_page/desktop_tab_item.dart';
part '../widget/about_us_page/desktop_right_panel.dart';
part '../widget/about_us_page/value_detail_panel.dart';
part '../widget/about_us_page/values_grid_desktop.dart';
part '../widget/about_us_page/value_grid_card.dart';
part '../widget/about_us_page/about_body_mobile.dart';
part '../widget/about_us_page/mobile_top_tab_item.dart';
part '../widget/about_us_page/mobile_about_us_content.dart';
part '../widget/about_us_page/mobile_tab_data.dart';
part '../widget/about_us_page/mobile_accordion_item.dart';
part '../widget/about_us_page/values_grid_mobile.dart';
